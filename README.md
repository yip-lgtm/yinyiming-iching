...
## v4.2 非對稱 Threshold 設計理念

**核心發現：** UP 和 DOWN 信號的"質量"唔同，唔可以用同一個 threshold。

| 方向 | Threshold | 信號數 | 精準度 | 原因 |
|------|-----------|--------|--------|------|
| UP | ≥4 | 238 | 37.8% | 妻財代表資金流入，稍微寬鬆捕捉機會 |
| DOWN | ≥6 | 220 | 44.5% | 兄弟代表波動/回調，需要更強確認才出手 |

**為什麼 DOWN 要更嚴格？**
- 市場多頭趨勢下，假突破多
- 兄弟強只代表"波動"，唔一定係"跌"
- 收緊 threshold 後 DOWN 精準度從 39.4% → 44.5%（+5%）

**美國交易時段（UTC 13-21）= 香港時間 21:00-05:00**

```
美國段 3,780 筆數據回測結果：
UP:   238 signals, 37.8%
DOWN: 220 signals, 44.5%
HOLD: 3,322 (非美國段 + 信號不明確)
```
